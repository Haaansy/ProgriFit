...
class StartTraining: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(workoutVal == "Upper-Body") {
            ...
            exerciseInfo = UpperBodyExercises.getExercise(workoutLoc, workoutExerciseName)
        } else if(workoutVal == "Lower-Body") {
            subheaderText.text = workoutLoc
            exerciseInfo = LowerBodyExercises.getExercise(workoutLoc, workoutExerciseName)
        } else if(workoutVal == "Core") {
            subheaderText.text = ""
            exerciseInfo = CoreExercises.getExercise(workoutLoc, workoutExerciseName)
